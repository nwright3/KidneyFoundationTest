...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main">
        <article>
            ...
            <p>To facilitate programs, services and educational opportunities designed specifically to serve the needs of kidney disease patients in our community to include 
                the counties of Nueces, Jim Wells, Live Oak, Bee, Refugio, Aransas, San Patricio, Kleberg, Brooks and Kenedy.</p>
            <h3>Goals</h3>
            <p>1.    Expand public awareness about kidney disease and the need for organ donation through public education.
...
4.    Stage special events to further develop donor relationships with foundations, corporations and individuals.</p>
            <h3>History</h3>
            <p>For over 43 years, the Coastal Bend Kidney Foundation (formerly the National Kidney Foundation of the Texas Coastal Bend) has provided programs and services 
                ...
                exponential and community support has become essential.</p>
            <p>In 2006, our Board of Directors chose to end our association with the national organization and form a new organization that focuses our programs and services 
                ...
                continue to be an important focus, as well.</p>
            <p>CBKF is served by a board of directors, which includes representatives from renal patients, health professionals, and corporate and community leaders. Our activities 
                are managed on a daily basis by Executive Director, Becky Gardner, and a contracted support staff.</p>
            <p>CBKF is an active member of the South Texas community. Our agency actively networks with Driscoll Children’s Hospital system, area dialysis units, and renal professionals. 
